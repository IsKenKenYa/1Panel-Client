...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `database` | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ | ❌ | ❌ | 仅薄列表页，page 直连 `getDatabaseApi()` |
| `firewall` | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | 仅薄规则页，page 直连 `getFirewallApi()` |
| `website` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | 主链路可达，但能力覆盖与结构化程度远低于上游 |
| `website_domain` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | 仅基础 CRUD，缺更新/校验/批量提示 |
| `website_config` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | 仍以原始文本/scope 参数编辑为主 |
