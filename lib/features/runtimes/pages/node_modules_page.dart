...
class _NodeModulesPageState extends State<NodeModulesPage> {
  ...
  Future<void> _installModule() async {
    final success = await context.read<NodeModulesProvider>().installInputModule();
    if (!mounted) {
      return;
    }
  ...
  Future<void> _uninstallModule(String module) async {
    final success = await context.read<NodeModulesProvider>().uninstallModule(module);
    if (!mounted) {
      return;
    }
    ScaffoldMessenger.of(context).showSnackBar(
